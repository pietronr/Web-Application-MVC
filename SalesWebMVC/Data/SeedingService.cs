...
namespace SalesWebMVC.Data
{
    public class SeedingService 
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Stone", "stone@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Pokz", "pokz@gmail.com", new DateTime(2001, 5, 26), 2000.0, d2);
            Seller s3 = new Seller(3, "Mantis", "mantis@gmail.com", new DateTime(2001, 1, 28), 3500.0, d1);
            Seller s4 = new Seller(4, "Husky", "husky@gmail.com", new DateTime(2000, 12, 3), 800.0, d4);
            Seller s5 = new Seller(5, "Digolas", "digolas@gmail.com", new DateTime(2000, 10, 21), 1200.0, d3);
            Seller s6 = new Seller(6, "Montinha", "monta@gmail.com", new DateTime(2001, 6, 14), 4200.0, d2);
